...
-- Add doctor_name column if it doesn't exist (migration for existing tables)
ALTER TABLE appointment ADD COLUMN IF NOT EXISTS doctor_name TEXT;
...
INSERT INTO appointment (appointment_id, patient_id, doctor_id, doctor_name, start_time, end_time, reason, version)
SELECT
