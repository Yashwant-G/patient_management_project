...
ALTER TABLE appointment ADD COLUMN IF NOT EXISTS appointment_date DATE;
ALTER TABLE appointment ADD COLUMN IF NOT EXISTS slot_id UUID;
ALTER TABLE appointment ADD COLUMN IF NOT EXISTS saga_id UUID;
ALTER TABLE appointment ADD COLUMN IF NOT EXISTS amount NUMERIC(12,2);
ALTER TABLE appointment ADD COLUMN IF NOT EXISTS payment_method TEXT;
ALTER TABLE appointment ADD COLUMN IF NOT EXISTS txn_id TEXT;
ALTER TABLE appointment ADD COLUMN IF NOT EXISTS appointment_status TEXT;
ALTER TABLE appointment ADD COLUMN IF NOT EXISTS created_at TIMESTAMP NOT NULL DEFAULT NOW();
ALTER TABLE appointment ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP NOT NULL DEFAULT NOW();
